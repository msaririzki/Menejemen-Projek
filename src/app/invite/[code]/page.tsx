          ...
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Link invite ini tidak valid atau sudah kadaluarsa.
              </p>
              <Button
            ...
            <div className="space-y-6">
              ...
              {isAuthenticated ? (
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    onClick={handleLogin}
                    className="w-full rounded-xl h-11 bg-white hover:bg-gray-100 text-zinc-900 font-medium gap-2 cursor-pointer"
                  >
